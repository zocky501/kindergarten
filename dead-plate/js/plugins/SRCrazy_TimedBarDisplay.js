 ...
 * @desc The file to use for the foreground image
 * @require 1
 * @dir img/pictures/
 * @type file
 * 
...
(function($, $core)
{
	...
	if ($core)
	{
		$core.registerPlugin($, "SRCrazy_TimedBarDisplay", "1.2.0", "2016-11-29", true);
	}
	else
	{
	...
	$.showFgImage = ($.Params["Show Foreground Image"].toLowerCase() === "true");
	$.fgImage = $.Params["Foreground Image"];
	...
	Container_TimedDisplay.prototype.initialize = function(x, y, text, time, isRealTime)
	{
		...
		{
			this.drawImage(x, y, $.bgImage);
		}
		
		if ($.showFgImage)
		{
			this.drawImage(x, y, $.fgImage);
		}
	 ...
	 * @param y Positionon y-axis
	 */
	Container_TimedDisplay.prototype.drawImage = function(x, y, image)
	{
		var path = 'img/pictures/' + image + '.png';
